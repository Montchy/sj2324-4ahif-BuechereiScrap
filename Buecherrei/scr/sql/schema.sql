    ...
    create table person_currently_borrowed (
    ...
    alter table if exists borroweditems_user 
       add constraint FK8cf64lim4d1sx0evlt4ay9e3t 
       foreign key (user_id) 
       references person;
    ...
    alter table if exists libraries 
       add constraint FKo0xaubeks8ch6ibyo6mp1oqg7 
    ...
    alter table if exists memberships 
       add constraint FK63h5r255j3a0mxp3mpyjvtj4m 
       foreign key (user_id) 
       references person;

    alter table if exists person 
       add constraint FKcr2j020j33iaoigqjikmyqb6d 
       foreign key (phone_number_id) 
       references phonenumbers;

    alter table if exists person 
       add constraint FK887dtcq3rrascaotvbjc7brsf 
       foreign key (social_security_number_id) 
       references socialsecuritynumbers;

    alter table if exists person 
       add constraint FKkb8fb0ej36oy25j0363bncd30 
       foreign key (manager_id) 
       references person;

    alter table if exists person_currently_borrowed 
       add constraint FKtrxblp0q3reispfyg3qahptxo 
       foreign key (currently_borrowed_id) 
       references borroweditems;

    alter table if exists person_currently_borrowed 
       add constraint FKsygjs5ovxn2rhlnmkp10elb80 
       foreign key (user_id) 
       references person;

    alter table if exists person_employees 
       add constraint FK1m2j534tjh00otitd22laqp57 
       foreign key (employees_id) 
       references person;

    alter table if exists person_employees 
       add constraint FKq0og3wfu1ixsg3x5vv5ympjkn 
       foreign key (employee_id) 
       references person;

    alter table if exists person_libraries 
       add constraint FK7ftcm6b8sfiqj358hmsr5amgh 
       foreign key (libraries_id) 
       references libraries;

    alter table if exists person_libraries 
       add constraint FKdrmxflcx9pu8nbd9nj5hlgww5 
       foreign key (employee_id) 
       references person;

    alter table if exists person_memberships 
       add constraint FKo2fjbl4q43fi5t90twjlxi792 
       foreign key (memberships_member_till, memberships_user_id) 
       references memberships;

    alter table if exists person_memberships 
       add constraint FK2x6u8cm75ljqf2tqulw5ras04 
       foreign key (user_id) 
       references person;

    alter table if exists person_trainings 
       add constraint FK8kqi3wpl7cfni9jr240v8ua98 
       foreign key (trainings_training_start, trainings_trainee_id) 
       references training;

    alter table if exists person_trainings 
       add constraint FK2n4hml2o4tb6gl5lxn8v3c78k 
       foreign key (employee_id) 
       references person;

    alter table if exists phonenumbers 
       add constraint FKo2poqqmrhbusctck2d789nxcc 
       foreign key (person_id) 
       references person;

    alter table if exists socialsecuritynumbers 
       add constraint FKf7ir1p4a8mdbasmbcd1ndkht2 
       foreign key (person_id) 
       references person;

    alter table if exists training 
       add constraint FKmsw3t5mm5rbtiks7ymka6ndxa 
       foreign key (trainee_id) 
       references person;

    alter table if exists training 
       add constraint FKf74wcsabsy4tqptpaovb4y7r2 
